...
POST = (miniSearch restituisce tot:
        tot = 0 --> e' finito l'albero o il carattere successivo non corrisponde a quello del pattern
        tot = 1 --> abbiamo finito il pattern e l'abbiamo trovato tutto, quindi ritorno quanti pattern abbiamo trovato: 1
        tot = 2 --> abbiamo cercato a destra e a sinistra e abbiamo trovato pattern da entrambe le parti)
*/
