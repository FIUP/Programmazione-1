...
/*POST_level=(r è ottenuto da vr aggiungendo a vr min(Offre(vr,lev), dim) nodi a livello lev da sinistra a
destra, la funzione deve restituire col return dim-Offre(vr,lev) qualora questa quantità fosse positiva e
...
/*POST_build=(r è ottenuto da vr aggiungendo a vr dim nuovi nodi (con campo info letto da INP e tali che
questi nodi siano inseriti a partire dal primo livello l tale che Offre(vr,l) >0 , poi al livello l+1, l+2 e così via,
